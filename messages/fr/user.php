...
return array(
        ...
        'Please activate you account go to {activation_url}' => "Pour activer votre compte veuillez cliquer sur le lien suivant {activation_url}",
        ...
        'Please enter the letters as they are shown in the image above.' => "veuillez entrez les lettres telles qu'elles figurent dans l'image ci-dessus.",
        ...
        'Thank you for your registration. Please check your email or login.' => "Nous vous remercions de votre inscription. veuillez vérifier votre e-mail ou login.",
        'Thank you for your registration. Please check your email.' => "Nous vous remercions de votre inscription. veuillez vérifier votre email.",
        'Please check your email. An instructions was sent to your email address.' => "veuillez vérifier votre email. Une instruction a été envoyée à votre adresse e-mail.",
        ...
        'Restore' => 'Restaurer',
        'Please enter your login or email addres.' => "veuillez entrer votre login ou votre adresse e-mail.",
        ...
        'Active' => 'Actif',
        'Banned' => 'Banni',
        'Please fill out the following form with your login credentials:' => "veuillez remplir le formulaire suivant avec vos identifiants de connexion:",
